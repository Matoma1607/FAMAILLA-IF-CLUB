    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {isModalOpen && (
        <div 
          ...
          onClick={() => { setIsModalOpen(false); setEditingEnt(null); }}
        >
          <div 
          ...
          >
            <div className="p-6 border-b flex justify-between items-center bg-slate-50 rounded-t-[2.5rem] shrink-0">
              ...
              <button onClick={() => { setIsModalOpen(false); setEditingEnt(null); }} className="text-slate-400 hover:text-slate-600 p-2 transition-colors cursor-pointer"><X size={24} /></button>
            </div>
